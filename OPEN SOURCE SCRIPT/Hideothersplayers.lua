...
v128.Home:AddButton(
    {
        ...
        ["Callback"] = function()
            ...
            while true do
                if (v149 == 0) then
                    v150 = "https://discord.gg/cPZ4BRTJ9V"
...
v128.Home:AddParagraph(
    {
        ["Title"] = "Credits",
        ["Content"] = "@i2idiot Scripter Onwer And Onwer And Developer"
    }
)
v128.Home:AddParagraph(
    {
        ["Title"] = "Join our discord server",
        ["Content"] = "Join here https://discord.gg/cPZ4BRTJ9V"
    }
)
v128.Main:AddButton(
    {

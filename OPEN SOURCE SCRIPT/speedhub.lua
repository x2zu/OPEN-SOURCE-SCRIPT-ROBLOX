local Speed_Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/zryr/Speed-Hub-X-Enhanced-UI/refs/heads/main/SHX-V5-Opt-w-Search-Dropdown.lua"))()
...
local section = mainTab:AddButton({
    Title = "Test"
})
